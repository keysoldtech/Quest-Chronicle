...
const spellCards = [
    ...
    { name: "Illumination", type: "Spell", apCost: 0, class: ["Mage", "Cleric", "Ranger"], effect: { type: "utility", utilityType: "light", description: "An object you touch emits bright light in a 20-foot radius and dim light for an additional 20 feet. The light lasts for 10 minutes." } },
    ...
    { name: "Restore Form", type: "Spell", apCost: 0, class: ["Mage", "Cleric", "Ranger"], effect: { type: "utility", utilityType: "repair", description: "This spell repairs a single break or tear in an object you touch, such as a broken chain link, two halves of a broken key, a torn cloak, or a leaking wineskin." } },
    ...
    { name: "Mind Scan", type: "Spell", apCost: 2, class: ["Mage"], effect: { type: "utility", utilityType: "information", description: "Allows you to read the surface thoughts of creatures within 30 feet for 1 minute." } },
    ...
    { name: "Umbral Sphere", type: "Spell", apCost: 2, class: ["Mage"], effect: { type: "utility", utilityType: "field_effect", description: "A 15-foot radius sphere of magical darkness extends from a point you choose. The darkness spreads around corners. A creature with darkvision can't see through this darkness, and nonmagical light can't illuminate it. It lasts for 10 minutes." } },
    ...
    // Level 3
    { name: "Abolish Magic", type: "Spell", apCost: 3, class: ["Mage", "Cleric"], effect: { type: "utility", utilityType: "dispelling", description: "Ends one spell on a creature or object." } },
    ...
    { name: "Grand Illusion", type: "Spell", apCost: 3, class: ["Mage"], effect: { type: "utility", utilityType: "illusion", description: "Creates the illusion of an object, creature, or other visible phenomenon for 10 minutes." } },
    ...
    { name: "Magic Negation", type: "Spell", apCost: 3, class: ["Mage", "Cleric"], effect: { type: "utility", utilityType: "dispelling", description: "Attempts to negate another spell." } },
