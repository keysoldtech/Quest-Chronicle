...
const weaponCards = [
    { id: nextId(), name: "Axechuck", type: "Weapon", class: ["Barbarian", "Ranger", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 1 }, description: "Thrown (20/60), Special: Returning Edge - Returns to hand at end of turn (If thrown and hand free)." } },
    { id: nextId(), name: "Axechuck", type: "Weapon", class: ["Barbarian", "Ranger", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 1 }, description: "Thrown (20/60), Special: Returning Edge - Returns to hand at end of turn (If thrown and hand free)." } },
    { id: nextId(), name: "Balanced Steel", type: "Weapon", class: ["Warrior", "Rogue", "Ranger"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 1 }, description: "Versatile (1d10), Special: Guard Breaker - Ignore 1 point of target's Shield Bonus (Versatile only, 1/turn)." } },
    { id: nextId(), name: "Balanced Steel", type: "Weapon", class: ["Warrior", "Rogue", "Ranger"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 1 }, description: "Versatile (1d10), Special: Guard Breaker - Ignore 1 point of target's Shield Bonus (Versatile only, 1/turn)." } },
    { id: nextId(), name: "Bolt Sprinter", type: "Weapon", class: ["Rogue", "Ranger", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 1 }, description: "Ammunition, Loading, Special: Steady Aim - First attack on next turn deals +1d4 damage (If used Brace action this turn)." } },
    { id: nextId(), name: "Bolt Sprinter", type: "Weapon", class: ["Rogue", "Ranger", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 1 }, description: "Ammunition, Loading, Special: Steady Aim - First attack on next turn deals +1d4 damage (If used Brace action this turn)." } },
    { id: nextId(), name: "Bone Thumper", type: "Weapon", class: ["Barbarian", "Cleric", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 1 }, description: "Special: Solid Strike - Deal an additional 1 damage (When hitting target with Shield Bonus from armor, not shield)." } },
    { id: nextId(), name: "Bone Thumper", type: "Weapon", class: ["Barbarian", "Cleric", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 1 }, description: "Special: Solid Strike - Deal an additional 1 damage (When hitting target with Shield Bonus from armor, not shield)." } },
    { id: nextId(), name: "Doomcleaver", type: "Weapon", class: ["Barbarian", "Warrior"], apCost: 2, effect: { type: "damage", dice: "2d6", bonuses: { damageBonus: 3 }, description: "Two-Handed, Heavy, Special: Savage Chop - Make 1 additional melee attack vs same target (Natural 20 on attack roll)." } },
    { id: nextId(), name: "Doomcleaver", type: "Weapon", class: ["Barbarian", "Warrior"], apCost: 2, effect: { type: "damage", dice: "2d6", bonuses: { damageBonus: 3 }, description: "Two-Handed, Heavy, Special: Savage Chop - Make 1 additional melee attack vs same target (Natural 20 on attack roll)." } },
    { id: nextId(), name: "Duelist's Point", type: "Weapon", class: ["Rogue", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 2 }, description: "Finesse, Special: Opening Flourish - First successful attack deals +1d4 damage (If first creature to attack target in combat)." } },
    { id: nextId(), name: "Duelist's Point", type: "Weapon", class: ["Rogue", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 2 }, description: "Finesse, Special: Opening Flourish - First successful attack deals +1d4 damage (If first creature to attack target in combat)." } },
    { id: nextId(), name: "Farstrike Bow", type: "Weapon", class: ["Ranger", "Rogue", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 2 }, description: "Ammunition, Heavy, Two-Handed, Special: Piercing Shot - +1 Attack Roll but ignore 1 point of target's Shield Bonus (Ranged, 1/turn)." } },
    { id: nextId(), name: "Farstrike Bow", type: "Weapon", class: ["Ranger", "Rogue", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 2 }, description: "Ammunition, Heavy, Two-Handed, Special: Piercing Shot - +1 Attack Roll but ignore 1 point of target's Shield Bonus (Ranged, 1/turn)." } },
    { id: nextId(), name: "Impact Cleaver", type: "Weapon", class: ["Barbarian", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 2 }, description: "Versatile (1d10), Heavy, Special: Momentum Swing - Increase movement speed by 5 ft until end of turn (Versatile hit)." } },
    { id: nextId(), name: "Impact Cleaver", type: "Weapon", class: ["Barbarian", "Warrior"], apCost: 1, effect: { type: "damage", dice: "1d8", bonuses: { damageBonus: 2 }, description: "Versatile (1d10), Heavy, Special: Momentum Swing - Increase movement speed by 5 ft until end of turn (Versatile hit)." } },
    { id: nextId(), name: "Quick Blade", type: "Weapon", class: ["Rogue", "Ranger"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 1 }, description: "Finesse, Special: Fluid Motion - Can use Break Away for 0 AP (If make two attacks with this weapon on turn)." } },
    { id: nextId(), name: "Quick Blade", type: "Weapon", class: ["Rogue", "Ranger"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 1 }, description: "Finesse, Special: Fluid Motion - Can use Break Away for 0 AP (If make two attacks with this weapon on turn)." } },
    { id: nextId(), name: "Shadowtooth", type: "Weapon", class: ["Rogue"], apCost: 1, effect: { type: "damage", dice: "1d4", bonuses: { damageBonus: 1 }, description: "Finesse, Thrown (20/60), Special: Poison Ready - Advantage on attack roll when applying poison." } },
    { id: nextId(), name: "Shadowtooth", type: "Weapon", class: ["Rogue"], apCost: 1, effect: { type: "damage", dice: "1d4", bonuses: { damageBonus: 1 }, description: "Finesse, Thrown (20/60), Special: Poison Ready - Advantage on attack roll when applying poison." } },
    { id: nextId(), name: "Swiftflight Bow", type: "Weapon", class: ["Ranger", "Rogue"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 1 }, description: "Ammunition, Close-Range Penalty (-1d4 damage when attacking Close enemy)" } },
    { id: nextId(), name: "Swiftflight Bow", type: "Weapon", class: ["Ranger", "Rogue"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 1 }, description: "Ammunition, Close-Range Penalty (-1d4 damage when attacking Close enemy)" } },
    { id: nextId(), name: "Wayfinder's Staff", type: "Weapon", class: ["Mage", "Cleric", "Ranger"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 0 }, description: "Versatile (1d8), Special: Deflect - As Reaction, spend 1 AP to gain +2 to Required Roll to Hit vs attacker (Until start of next turn)." } },
    { id: nextId(), name: "Wayfinder's Staff", type: "Weapon", class: ["Mage", "Cleric", "Ranger"], apCost: 1, effect: { type: "damage", dice: "1d6", bonuses: { damageBonus: 0 }, description: "Versatile (1d8), Special: Deflect - As Reaction, spend 1 AP to gain +2 to Required Roll to Hit vs attacker (Until start of next turn)." } },
];

const armorCards = [
    { id: nextId(), name: "Arcanist's Weave", type: "Armor", class: ["Warrior", "Mage", "Rogue", "Cleric", "Ranger", "Barbarian"], effect: { description: "+1 to Magic Resistance.", bonuses: { shieldBonus: 2, ap: 2 } }, guardBonus: 2 },
    { id: nextId(), name: "Arcanist's Weave", type: "Armor", class: ["Warrior", "Mage", "Rogue", "Cleric", "Ranger", "Barbarian"], effect: { description: "+1 to Magic Resistance.", bonuses: { shieldBonus: 2, ap: 2 } }, guardBonus: 2 },
    { id: nextId(), name: "Bastion Shield", type: "Armor", class: ["Warrior", "Cleric", "Ranger", "Barbarian"], effect: { description: "Provides cover to adjacent allies.", bonuses: { shieldBonus: 3, ap: -1 } }, guardBonus: 2 },
    { id: nextId(), name: "Bastion Shield", type: "Armor", class: ["Warrior", "Cleric", "Ranger", "Barbarian"], effect: { description: "Provides cover to adjacent allies.", bonuses: { shieldBonus: 3, ap: -1 } }, guardBonus: 2 },
    { id: nextId(), name: "Crystal Hide", type: "Armor", class: ["Warrior", "Cleric", "Ranger", "Barbarian"], effect: { description: "Resistance to non-magical damage.", bonuses: { shieldBonus: 6, ap: 0 } }, guardBonus: 4 },
    { id: nextId(), name: "Crystal Hide", type: "Armor", class: ["Warrior", "Cleric", "Ranger", "Barbarian"], effect: { description: "Resistance to non-magical damage.", bonuses: { shieldBonus: 6, ap: 0 } }, guardBonus: 4 },
    { id: nextId(), name: "Earth-Forged Mail", type: "Armor", class: ["Warrior"], effect: { description: "Resistance to Bludgeoning damage.", bonuses: { shieldBonus: 7, ap: -1, hp: 5 } }, guardBonus: 4 },
    { id: nextId(), name: "Earth-Forged Mail", type: "Armor", class: ["Warrior"], effect: { description: "Resistance to Bludgeoning damage.", bonuses: { shieldBonus: 7, ap: -1, hp: 5 } }, guardBonus: 4 },
    { id: nextId(), name: "Fury Cuirass", type: "Armor", class: ["Warrior", "Cleric", "Ranger", "Barbarian"], effect: { description: "While below half health, gain +1 to attack rolls.", bonuses: { shieldBonus: 6, ap: 1 } }, guardBonus: 4 },
    { id: nextId(), name: "Fury Cuirass", type: "Armor", class: ["Warrior", "Cleric", "Ranger", "Barbarian"], effect: { description: "While below half health, gain +1 to attack rolls.", bonuses: { shieldBonus: 6, ap: 1 } }, guardBonus: 4 },
    { id: nextId(), name: "Hide Vest", type: "Armor", class: ["Warrior", "Mage", "Rogue", "Cleric", "Ranger", "Barbarian"], effect: { description: "None", bonuses: { shieldBonus: 2, ap: 1 } }, guardBonus: 2 },
    { id: nextId(), name: "Hide Vest", type: "Armor", class: ["Warrior", "Mage", "Rogue", "Cleric", "Ranger", "Barbarian"], effect: { description: "None", bonuses: { shieldBonus: 2, ap: 1 } }, guardBonus: 2 },
    { id: nextId(), name: "Indomitable Plating", type: "Armor", class: ["Warrior"], effect: { description: "Ignores the first point of damage from any attack.", bonuses: { shieldBonus: 10, ap: -2 } }, guardBonus: 6 },
    { id: nextId(), name: "Indomitable Plating", type: "Armor", class: ["Warrior"], effect: { description: "Ignores the first point of damage from any attack.", bonuses: { shieldBonus: 10, ap: -2 } }, guardBonus: 6 },
    { id: nextId(), name: "Ironclad Harness", type: "Armor", class: ["Warrior"], effect: { description: "None", bonuses: { shieldBonus: 8, ap: -1 } }, guardBonus: 5 },
    { id: nextId(), name: "Ironclad Harness", type: "Armor", class: ["Warrior"], effect: { description: "None", bonuses: { shieldBonus: 8, ap: -1 } }, guardBonus: 5 },
