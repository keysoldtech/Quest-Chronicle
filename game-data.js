...
// --- 1. CLASSES ---
const classes = {
    Barbarian: { baseHp: 24, baseDamageBonus: 4, baseShieldBonus: 0, baseAp: 3, healthDice: 4, stats: { str: 4, dex: 1, con: 3, int: 0, wis: 0, cha: 1 }, ability: { name: 'Unchecked Assault', apCost: 1, cost: { type: 'discard', cardType: 'Weapon' }, description: 'Discard a Weapon card to add +6 damage to your next successful weapon attack this turn.' }, startingDeck: { 'Combustion Flask': 2 } },
    Cleric:    { baseHp: 20, baseDamageBonus: 1, baseShieldBonus: 3, baseAp: 2, healthDice: 3, stats: { str: 1, dex: 0, con: 2, int: 1, wis: 4, cha: 2 }, ability: { name: 'Divine Aid', apCost: 1, cost: null, description: 'Gain a +1d4 bonus to your next d20 roll (attack or challenge) this turn.' }, startingDeck: { 'Healing Word': 1, 'Guiding Bolt': 1, 'Purifying Flask': 1 } },
    Mage:      { baseHp: 18, baseDamageBonus: 1, baseShieldBonus: 2, baseAp: 2, healthDice: 2, stats: { str: 0, dex: 1, con: 1, int: 4, wis: 2, cha: 1 }, ability: { name: 'Mystic Recall', apCost: 1, cost: null, description: 'Draw one card from the Spell deck.' }, startingDeck: { 'Magic Missile': 1, 'Fire Bolt': 1, 'Everbright Stick': 1 } },
    Ranger:    { baseHp: 20, baseDamageBonus: 2, baseShieldBonus: 2, baseAp: 2, healthDice: 3, stats: { str: 1, dex: 4, con: 2, int: 1, wis: 3, cha: 0 }, ability: { name: 'Hunters Mark', apCost: 1, cost: null, description: 'Mark a monster. All attacks against it deal +2 damage for one round.' }, startingDeck: { 'Antidote': 1, 'Sturdy Cord (50 ft)': 1, 'Combustion Flask': 1 } },
    Rogue:     { baseHp: 18, baseDamageBonus: 3, baseShieldBonus: 1, baseAp: 3, healthDice: 2, stats: { str: 1, dex: 4, con: 1, int: 2, wis: 0, cha: 3 }, ability: { name: 'Evasion', apCost: 2, cost: null, description: 'For one round, all attacks against you have disadvantage (DM rerolls hits).' }, startingDeck: { 'Combustion Flask': 2, 'Lockpicks & Shims': 1 } },
    Warrior:   { baseHp: 22, baseDamageBonus: 2, baseShieldBonus: 4, baseAp: 3, healthDice: 4, stats: { str: 3, dex: 2, con: 4, int: 0, wis: 1, cha: 1 }, ability: { name: 'Weapon Surge', apCost: 1, cost: { type: 'discard', cardType: 'Weapon' }, description: 'Discard a Weapon card to add +4 damage to your next successful weapon attack this turn.' }, startingDeck: { 'Purifying Flask': 1, 'Antidote': 1 } },
};
