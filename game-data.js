...
const allMonsters = [
    { name: "Phantom Light", tier: 1, type: "Monster", maxHp: 5, requiredRollToHit: 12, attackBonus: 2, ap: 1, effect: { type: "damage", dice: "1d8", description: "Incorporeal Movement. Proximity damage." } },
    { name: "Ember Flicker", tier: 1, type: "Monster", maxHp: 6, requiredRollToHit: 12, attackBonus: 4, ap: 2, effect: { type: "damage", dice: "1d10", description: "On miss: Ignite (DC 12 DEX save or catch fire, 1d4 fire/turn)." } },
    { name: "Pestie Prowler", tier: 1, type: "Monster", maxHp: 7, requiredRollToHit: 10, attackBonus: 8, ap: 2, effect: { type: "damage", dice: "1d6", description: "Sneaky Escape — Dex roll (DC 12) to flee if ≤ 3 HP." } },
    { name: "Pestie Pilferer", tier: 1, type: "Monster", maxHp: 8, requiredRollToHit: 12, attackBonus: 4, ap: 2, effect: { type: "damage", dice: "1d6+2", description: "Quick Feet (Can Break Away as a bonus action.)." } },
    { name: "Grotto Weaver", tier: 1, type: "Monster", maxHp: 10, requiredRollToHit: 12, attackBonus: 6, ap: 2, effect: { type: "damage", dice: "1d6", description: "Web Shot (DC 10 Strength save to escape)." } },
    { name: "Flutterwing Swarm", tier: 1, type: "Monster", maxHp: 10, requiredRollToHit: 12, attackBonus: 4, ap: 2, effect: { type: "damage", dice: "2d4", description: "Blind Flight (Immune to blindness conditions.)." } },
    { name: "Pestie Whisperer", tier: 1, type: "Monster", maxHp: 10, requiredRollToHit: 12, attackBonus: 3, ap: 2, effect: { type: "damage", dice: "1d4", description: "Tribal Magic (+2 attack for pesties)." } },
    { name: "Scale-kin Skulker", tier: 1, type: "Monster", maxHp: 10, requiredRollToHit: 12, attackBonus: 2, ap: 2, effect: { type: "damage", dice: "1d4+1", description: "Trap Master (Sets a trap at start of combat)." } },
    { name: "Essence Thief", tier: 1, type: "Monster", maxHp: 15, requiredRollToHit: 12, attackBonus: 4, ap: 2, effect: { type: "damage", dice: "2d6", description: "Incorporeal." } },
    { name: "Bone Archer", tier: 1, type: "Monster", maxHp: 18, requiredRollToHit: 12, attackBonus: 3, ap: 2, effect: { type: "damage", dice: "1d8", description: "Bone Resilience (Immune to poison and charm.)." } },
    { name: "Veiled Fanatic", tier: 1, type: "Monster", maxHp: 20, requiredRollToHit: 12, attackBonus: 5, ap: 2, effect: { type: "damage", dice: "1d4+3", description: "Unholy Fervor (Can re-roll a failed saving throw)." } },
    { name: "Striped Marauder", tier: 1, type: "Monster", maxHp: 23, requiredRollToHit: 12, attackBonus: 4, ap: 3, effect: { type: "damage", dice: "1d8+2", description: "Rampage (Make another attack on kill)." } },
    { name: "Segmented Horror", tier: 1, type: "Monster", maxHp: 24, requiredRollToHit: 12, attackBonus: 5, ap: 3, effect: { type: "damage", dice: "1d4+3", description: "Wall Climber." } },
    { name: "Stonegaze Wyrmlet", tier: 1, type: "Monster", maxHp: 24, requiredRollToHit: 12, attackBonus: 4, ap: 3, effect: { type: "damage", dice: "1d6+2", description: "Petrification Gaze (DC 12 CON save or petrified)" } },
    { name: "Caustic Sludge", tier: 1, type: "Monster", maxHp: 24, requiredRollToHit: 12, attackBonus: 3, ap: 2, effect: { type: "damage", dice: "1d8", description: "Split on Lightning." } },
    { name: "Sky Lurer", tier: 2, type: "Monster", maxHp: 27, requiredRollToHit: 12, attackBonus: 4, ap: 3, effect: { type: "damage", dice: "1d6+1", description: "Swooping Attack." } },
    { name: "Highway Scourge", tier: 2, type: "Monster", maxHp: 28, requiredRollToHit: 12, attackBonus: 6, ap: 3, effect: { type: "damage", dice: "2d6+3", description: "Shout (+1 attack for allies)." } },
    { name: "Ruined Sentinel", tier: 2, type: "Monster", maxHp: 33, requiredRollToHit: 13, attackBonus: 6, ap: 3, effect: { type: "damage", dice: "2d8", description: "Magic Resistance." } },
    { name: "Shadowmaw Alpha", tier: 2, type: "Monster", maxHp: 34, requiredRollToHit: 13, attackBonus: 5, ap: 3, effect: { type: "damage", dice: "2d6+2", description: "Pack Tactics." } },
    { name: "Stone Wing", tier: 2, type: "Monster", maxHp: 35, requiredRollToHit: 13, attackBonus: 5, ap: 3, effect: { type: "damage", dice: "1d6+3", description: "Stone Form." } },
    { name: "Haunted Cuirass", tier: 2, type: "Monster", maxHp: 41, requiredRollToHit: 13, attackBonus: 4, ap: 3, effect: { type: "damage", dice: "2d6", description: "Unyielding Form (Immune to poison, fear)." } },
    { name: "Greenskin Mauler", tier: 2, type: "Monster", maxHp: 44, requiredRollToHit: 14, attackBonus: 5, ap: 3, effect: { type: "damage", dice: "1d12+3", description: "Relentless Endurance (Survives at 1 HP)." } },
    { name: "Spectral Corruptor", tier: 2, type: "Monster", maxHp: 45, requiredRollToHit: 14, attackBonus: 6, ap: 3, effect: { type: "damage", dice: "3d6", description: "Incorporeal Passage." } },
    { name: "Axehorn Brute", tier: 2, type: "Monster", maxHp: 55, requiredRollToHit: 14, attackBonus: 7, ap: 4, effect: { type: "damage", dice: "2d12+4", description: "Labyrinthine Recall." } },
    { name: "Briar Witch", tier: 2, type: "Monster", maxHp: 59, requiredRollToHit: 14, attackBonus: 5, ap: 4, effect: { type: "damage", dice: "2d6", description: "Cackle of Madness (Confuse enemies)." } },
    { name: "Wrapped Ancient", tier: 2, type: "Monster", maxHp: 60, requiredRollToHit: 14, attackBonus: 5, ap: 4, effect: { type: "damage", dice: "2d6+3", description: "Undead Fortitude (Can drop to 1 HP)." } },
    { name: "Watery Charmer", tier: 3, type: "Monster", maxHp: 63, requiredRollToHit: 14, attackBonus: 6, ap: 4, effect: { type: "damage", dice: "1d6+3", description: "Captivating Song (Charmed)." } },
    { name: "Hill Oaf", tier: 3, type: "Monster", maxHp: 64, requiredRollToHit: 15, attackBonus: 6, ap: 4, effect: { type: "damage", dice: "2d8+4", description: "Powerful Blow (+2 damage)." } },
    { name: "Deathlord Marshal", tier: 3, type: "Monster", maxHp: 78, requiredRollToHit: 15, attackBonus: 7, ap: 4, effect: { type: "damage", dice: "3d6+4", description: "Unholy Endurance (Can rise with 10 HP)." } },
    { name: "Earth Colossus", tier: 3, type: "Monster", maxHp: 112, requiredRollToHit: 16, attackBonus: 8, ap: 5, effect: { type: "damage", dice: "2d10+5", description: "Immutable Form." } },
    { name: "Winter Juggernaut", tier: 3, type: "Monster", maxHp: 130, requiredRollToHit: 17, attackBonus: 9, ap: 5, effect: { type: "damage", dice: "3d12+6", description: "Icy Aura (Deals cold damage)." } },
    { name: "Hellfire Sovereign", tier: 3, type: "Monster", maxHp: 195, requiredRollToHit: 18, attackBonus: 9, ap: 6, effect: { type: "damage", dice: "4d6+5", description: "Hellish Regeneration." } },
    { name: "Rotwood Behemoth", tier: 3, type: "Monster", maxHp: 214, requiredRollToHit: 18, attackBonus: 8, ap: 6, effect: { type: "damage", dice: "3d8+4", description: "Rooted Horror (difficult terrain)." } },
];
